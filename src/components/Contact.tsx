...
const Contact = () => {
  return <section id="contact" className="py-20 lg:py-32 relative bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          }].map((item, index) => <Card key={index} className="bg-white border-gray-200 hover:border-primary transition-all duration-300 hover:shadow-lg">
